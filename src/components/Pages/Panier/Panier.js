                        ...
                        <div className="row ">
                            <div className="col-sm-12  col-md-8  p-4">
                                {   
                                    ...
                                    <div className="back-to-home">
                                        <Link to="/"><a className="btn back"><i className="fa fa-chevron-left me-2"></i>Continuer mes achats</a></Link>
                                    </div>
                            ...
                            </div>
                            {
                                            ...
                                            <div className="checkout text-center mt-5">
                                                    
                                               {
                                                   checkout ? (
                                                       ...
                                                       <button className="btn btn-white btn-sm" onClick={() => {setCheckOut(true);}}><i className="fa fa fa-shopping-cart"></i>Paiement</button>
                                                   )
                                               }
                                            </div>
                                ...
                                <div className="ibox-content number-support">
                                    <h6><i className="fa fa-phone"></i> 05 55 55 55 55</h6>
