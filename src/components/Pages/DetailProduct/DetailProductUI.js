              ...
              <div className="product-actions">
                <form>
                  <div className="product-add-cart">
                    <div className="mt-5">
                      <span className="number-quantity">
                        Il ne reste que <strong>{props.stock}</strong>{' '}
                        exemplaires
                      </span>
                    </div>
                  </div>
            ...
            <div className="product-description card-body ">
              ...
              <div className="product-description-content mt-3">
                <p>
                  ...
                  aliquam ex eu massa tempor bibendum. Mauris feugiat sapien
                  est, eu congue magna viverra bibendum. Praesent vitae orci
                  nisl. Vivamus cursus ante nec diam luctus mattis. Class aptent
                  taciti sociosqu ad litora torquent per conubia nostra, per
                  inceptos himenaeos. Quisque sem tellus, tristique vitae
                  elementum a, tempus ac eros. Suspendisse tellus tellus,
                  fermentum sit amet molestie a, vulputate eu odio. Nullam
                  bibendum, nibh et pretium faucibus, magna magna ornare nisl,
                  vitae malesuada sapien justo in justo. Sed vitae quam nisl.
                  Integer vitae vehicula risus. Duis at pulvinar tortor. Donec
                  augue odio, vestibulum nec tristique rhoncus, luctus eu
                  tortor.
                </p>
              </div>
            </div>
